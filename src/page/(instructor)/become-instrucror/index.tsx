...
const BecomeInstructorPage = () => {
  ...
  const handleMakeInstructor = async () => {
    setLoading(true)
    await makeInstructorApi({ paypal_email: user?.email as string })
  ...
  return (
    <div className='py-10 flex flex-col items-center'>
      <div className='text-center'>
        <h1 className='text-3xl font-bold mb-5 text-gray-200'>Trở thành giảng viên</h1>
        <p className='text-xl text-[#a1a1aa] '>Thiết lập khoản thanh toán để xuất bản các khóa học trên Edemy</p>
      </div>
